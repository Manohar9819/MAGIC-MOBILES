    ...
    <nav class="navbar navbar-dark bg-dark fixed-top navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav container-fluid">
                <a class="nav-link nava active" href="addtocard.jsp">To delete user<span class="sr-only">(current)</span></a>
	...
	<table class="container text-dark  table-striped   text-center  table-bordered" >
        ...
        <%
			try{
				...
				PreparedStatement check_stm=con.prepareStatement("select * from regiters");
		...
		%>
					<tr class=" text-dark  w-100" style="height: 45px;">
						...
						<td>*****</td>
						<td><%= userid %></td>
                        <td ><form action="delete.jsp" method="POST"> <button class="btn btn-info w-50"  name="del" value="<%= userid %>">Delete</button></form></td>
					</tr>
		<%
				}
				con.close();
