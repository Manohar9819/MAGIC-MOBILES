...
<div class=" container-fluid mb-4 pt-5"  >
  ...
  <div class="row mt-5">
    ...
    <div class="col-12 col-md-6 col-lg-3 pr-2 bl text-success pt-3">
      <p class="text-danger">Realme 5 pro <span class="righ"><b class="large symbol star p-4  w3-xxxlarge" id="changeButton1" style="width:100vh;"> &star;</b></span>
      </p>
    ...
    <div class="col-12 col-md-6 col-lg-3 bl text-success">
      <p class="text-danger pt-3">Brand Apple ,Model Name	IPhone <span class="righ"><b class="large star symbol p-4  w3-xxxlarge" id="changeButton2" style="width:100vh;"> &star;</b></span></p>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6 col-lg-3 pr-2 bl text-success pt-3">
      <p class="text-danger">Realme 5 pro <span class="righ"><b class="large symbol p-4 star  w3-xxxlarge" id="changeButton3" style="width:100vh;"> &star;</b>      </p>
      <p class="text-primary border border-light position-absolute ">Rating:4.5/5:-
          &ensp;  <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
    ...
    <div class="col-12 col-md-6 col-lg-3 bl text-success">
      <p class="text-danger pt-3">Brand Apple ,Model Name	IPhone <span class="righ"><b class="large symbol star   w3-xxxlarge"  id="changeButton4"  style="width:100vh;"> &star;</b></span></p>
      <p class="text-primary border border-light position-absolute">Rating:4.7/5
          &ensp;  <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
          <span class="fa fa-star checked"></span>
