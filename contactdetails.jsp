...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav container-fluid">
              ...
              <!-- <a class="nav-link nava active" href="#">Recent arrivals</a> -->
                ...
                <a class="nav-link nava active" href="#">User Queries</a>
    ...
    <div class="pt-5">
        <h1 class="text-center pt-2">User Queries</h1>
	<table class="container text-dark  table-striped   text-center  table-bordered" >
        ...
        <%
			try{
				...
				PreparedStatement check_stm=con.prepareStatement("select  * from contact_us  ");
